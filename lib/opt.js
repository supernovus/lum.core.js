  ...
  add(...sources)
  {
    ...
    for (let source of sources)
    {
      ...
      { // It's a source to add.
        ...
        { // Splice in at a position relative to the end.
          this.$sources.splice(pos+1, 0, source);
        }
        else
        { // Splice in at a position relative to the start.
          this.$sources.splice(pos, 0, source);
        }
      }
      else
      { // That's not valid.
