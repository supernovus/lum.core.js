...
{
  S,N,B,
  isObj,isComplex,isArray,isNil,isArrayOf,
  def
} = require('../types');
const {insert} = require('../arrays/add');

const OO = Symbol('@lumjs/core/opt.Opts:optimized');
 ...
 * 
 * @returns {boolean}
 * @alias module:@lumjs/core/opt.Opts.isPath
 */
 ...
 * @exports module:@lumjs/core/opt.Opts
 */
class Opts
{
  /**
