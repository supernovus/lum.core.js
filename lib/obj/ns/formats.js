...
/**
 * A collection of path formats and helpers for the obj.ns* functions.
 * 
 * A nested namespace object `NS.Format` is also available that contains
 * ONLY the format definitions themselves and no other helpers, etc.
 * 
 * Additionally, `NS.Defaults` is an array: `[Pointer, JSPath, Simple]`;
 * it is used as the default `opts.format` value.
 * 
