...
const NS = require('./formats');
const {isFormat} = NS;
NS.NS = NS; // recursive reference is recursive

/**
 * [INTERNAL] Generate an error message for nsString/nsArray functions.
 * @protected
 * @alias module:@lumjs/core/obj.NS.SOA
 ...
 * 
 * @returns {string[]} 
 * @alias module:@lumjs/core/obj.NS.nsArray
 */
 ...
 * @alias module:@lumjs/core/obj.NS.nsString
 */
 ...
 * 
 * Aliases: `obj.NS.getPath()`, `obj.ns.getPath()`.
 *
 ...
 * 
 * Aliases: `obj.NS.setPath()`, `obj.ns.setPath()`.
 * 
 ...
 * 
 * Aliases: `obj.NS.delPath()`, `obj.ns.delPath()`.
 * 
 ...
 * @alias module:@lumjs/core/obj.delObjectPath
 */
 ...
 * 
 * Deprecated alias: `obj.nsFactory` (will be removed in 2.0).
 * 
 * This function also contains alias properties for everything in `obj.NS`.
 * 
 ...
 * 
 * Also has `target` and `opts` properties for the arguments.
 * 
 * @alias module:@lumjs/core/obj.ns
 */
function nsFactory(target, opts={})
{
  ...
  const factory = 
  {
    ...
    get(pp,po) 
    { 
      return getObjectPath(target, pp, getOpts(po));
    },
    set(pp,po)
    { 
      setObjectPath(target, pp, getOpts(po));
      return this;
    },
    del(pp,po)
    { 
      delObjectPath(target, pp, getOpts(po));
      return this;
    },
  }
...
Object.assign(NS, {
  delObjectPath,
  delPath: delObjectPath,
  getNamespace,   // ← TODO: remove
  getObjectPath,
  getPath: getObjectPath,
  ns: nsFactory,
  nsArray,
  nsFactory,      // ← TODO: remove
  nsString,
  setNamespace,   // ← TODO: remove
  setObjectPath,
  setPath: setObjectPath,
  SOA,
});

Object.assign(nsFactory, NS);
