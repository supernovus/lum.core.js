...
const {assignd, assignTo} = require('./assignd');
...
const {weld, Weld} = require('./weld');

const 
{
  delObjectPath, getObjectPath, setObjectPath,
  getNamespace, setNamespace, nsFactory, // ← TODO: remove
} = NS;
...
{
  cp, getNamespace, setNamespace, nsFactory, // TODO: remove this line in 2.0

  apply, ApplyInfo, ApplyOpts, ApplyWith, assignd, assignTo,
  delObjectPath, df, dfa, dfor, discrete, flip, flipKeyVal, flipMap,
  getMethods, getObjectPath, getOwnKeys, getProperty, getPrototypesOf, 
  isEmptyObject, jc, lazy, MethodFilter, ns, NS, ownCount, 
  setObjectPath, signatureOf, unlocked, weaveAll, weaveAny, weld, Weld,
}
