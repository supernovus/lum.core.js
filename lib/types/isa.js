...
const {isObj,isArray,isIterable} = require('./basics');
...
class OfTest
{
   ...
   * 
   * @param {Array} [keyTypes] Array of type tests for the _key/index_.
   * 
   ...
   * If specified, it will be set as the `this.ktype` property.
   * 
 ...
 * 
 * If anything other than an `Array` is passed here, it will be wrapped
 * in an `Array` before passing to the `OfTest` constructor.
 * 
