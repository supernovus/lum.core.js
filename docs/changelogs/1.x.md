...
## [Unreleased]
### Fixed
- Changelog version links were missing for the last several versions.

## [1.39.3] - 2026-09-25
### Fixes
- Bugs in the `assignd()` function and its siblings.

## [1.39.2] - 2026-09-25
### Fixes
- Bugs in the `deprecate()` function and its siblings.

## [1.39.1] - 2026-08-26
This was actually done on `2026-08-18`, but I was once again away for a while.
### Fixes
- A couple typos in `obj.apply()` handlers.
### Changes
- Deprecation of `ctx.obj` in `obj.apply()` functions.
- Overhauled `obj.assignd()`; made it more modular and added several options.
- More modular cloning methods for `obj.unlocked()`.
- Renamed `obj.nsFactory()` to `obj.ns()`.
### Added
- `obj.NS` namespace for all *ObjectPath helpers. 
- `obj.jc()` as a cheap JSON-powered cloning function.
- `obj.weaveAll()` and `obj.weaveAny()` as recursive merging functions.
- `obj.weld()`, with extras in `obj.Weld`.

## [1.39.0] - 2026-07-07
Most of this was done on `2026-07-02`, but I was away for a few days.
### Changes
- Moved a bunch more deprecated stuff to [@lumjs/cp].
- Refactored the deprecation helpers in the `meta` module.
- Started deprecating things as per the TODO list.
### Added
- A `proxy` module with helpers for common Proxy related tasks.
- The `getOwnKeys()` function amongst others.

## [1.38.8] - 2026-02-04
### Changed
- Split most of `core/arrays` out into the [@lumjs/lists] package.
  Aliases will remain in v1.x for anything that was moved.
  Only a couple generic utility functions were left here.
- Renamed `test/arrays.js` to `test/arrays-list.js`.
### Added
- `move()` and `swap()` functions to `core/arrays` module.
- `test/arrays-swap.js` testing the new functions.

## [1.38.7] - 2026-01-30
### Changed
- Split the `core/traits` module into the [@lumjs/traits] package.
- Split `core/types/stringify` into the [@lumjs/describe] package.
- The `core/console` (LC) module switched from def() to df().
- Added `LC.muted(fn)` method to run a function with the
  JS console muted just for the duration of that call.
- Updated `test/types-basics.js` to use the new LC.muted() method
  instead of having manual calls to LC.mute() and LC.restore().
- A few minor tweaks here and there.

## [1.38.6] - 2026-01-08
### Fixed
- Added [@lumjs/cp] as a dependency, missed that somehow, whoops!

## [1.38.5] - 2026-01-06
### Added
- New `core/env` module that abstracts _environment_ variable usage.
- New `core/node` module for nodejs specific stuff.
### Changed
- Expanded the TODO plans significantly.
- Long overdue update of the `core/context` module.
- Moved `core/modules` to `core/node/modules` (alias left for 1.x).
- Major overhaul of the `core/obj.apply` function and related properties.
- Overhaul of the `core/obj.ns*` functions and related properties.
- Split `core/obj/cp` and a bunch of other related stuff into [@lumjs/cp].
...
[Unreleased]: https://github.com/supernovus/lum.core.js/compare/v1.39.3...HEAD
[1.39.3]: https://github.com/supernovus/lum.core.js/compare/v1.39.2...v1.39.3
[1.39.2]: https://github.com/supernovus/lum.core.js/compare/v1.39.1...v1.39.2
[1.39.1]: https://github.com/supernovus/lum.core.js/compare/v1.39.0...v1.39.1
[1.39.0]: https://github.com/supernovus/lum.core.js/compare/v1.38.8...v1.39.0
[1.38.8]: https://github.com/supernovus/lum.core.js/compare/v1.38.7...v1.38.8
[1.38.7]: https://github.com/supernovus/lum.core.js/compare/v1.38.6...v1.38.7
[1.38.6]: https://github.com/supernovus/lum.core.js/compare/v1.38.5...v1.38.6
[1.38.5]: https://github.com/supernovus/lum.core.js/compare/v1.38.4...v1.38.5
...
[@lumjs/cp]: https://github.com/supernovus/lum.cp.js
[@lumjs/describe]: https://github.com/supernovus/lum.describe.js
...
[@lumjs/traits]: https://github.com/supernovus/lum.traits.js
